...
This is a **LazyVim-based Neovim configuration** managed by mise. The config is located at `~/.config/mise/dotfiles/.config/nvim` but installed plugins reside in `~/.local/share/nvim/lazy/`.
