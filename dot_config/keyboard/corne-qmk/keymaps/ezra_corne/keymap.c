...
#define FULL_SCREEN C(G(KC_F))
#define SHOW_DESKTOP KC_F11
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAV_FN] = LAYOUT_split_3x6_3(
        ...
        QK_BOOT, S(G(KC_1)), S(G(KC_4)), FULL_SCREEN, SHOW_DESKTOP, C(G(KC_Q)), KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU,
                                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
