...
- Atuin and Television bash integrations are generated once into `~/.config/atuin/shell/integration.bash` and `~/.config/television/shell/integration.bash`, then sourced directly from `~/.bashrc`
