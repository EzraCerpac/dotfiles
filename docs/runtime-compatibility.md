...
- The audit proposed moving the five Pi plugins out of mise npm declarations and wiring `tasks/setup/exceptions/pi-plugins` after encrypted user settings were present. That updater and its seed configuration are no longer part of the current setup.
