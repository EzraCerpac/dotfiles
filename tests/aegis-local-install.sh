...
run_helper() {
    local tmp="${1:?temporary directory required}"
    local revision="${AEGIS_RUN_REVISION:-8415600350632adafbe246fe2b95273d9fa5a824}"
...
test_successful_install() (
    ...
    grep -Fqx 'revision=8415600350632adafbe246fe2b95273d9fa5a824' "$tmp/state/receipt" || \
