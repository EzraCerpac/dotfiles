...
run_helper() {
    local tmp="${1:?temporary directory required}"
    local revision="${AEGIS_RUN_REVISION:-bcc70ca7f9146bd1c1f8057f9b4f1ada53e77bfa}"
...
test_successful_install() (
    ...
    grep -Fqx 'revision=bcc70ca7f9146bd1c1f8057f9b4f1ada53e77bfa' "$tmp/state/receipt" || \
