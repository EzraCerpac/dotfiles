...
run_helper() {
    local tmp="${1:?temporary directory required}"
    local revision="${AEGIS_RUN_REVISION:-1819fbfbeba87bb271d94a31cd0487ef1641dac0}"
...
test_successful_install() (
    ...
    grep -Fqx 'revision=1819fbfbeba87bb271d94a31cd0487ef1641dac0' "$tmp/state/receipt" || \
