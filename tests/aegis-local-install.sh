...
run_helper() {
    local tmp="${1:?temporary directory required}"
    local revision="${AEGIS_RUN_REVISION:-b3aaf99b4853376e314e19588ef2a976e732b4c4}"
...
test_successful_install() (
    ...
    grep -Fqx 'revision=b3aaf99b4853376e314e19588ef2a976e732b4c4' "$tmp/state/receipt" || \
