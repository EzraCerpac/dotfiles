...
- **Rift rollback**: The Homebrew package, tracked config, and LaunchAgent remain managed. The cutover disabled Rift's agent with `launchctl`; routine package reconciliation does not re-enable it. Rollback requires an explicit manager handoff.
